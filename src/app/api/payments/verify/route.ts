...
export async function POST(request: NextRequest) {
    try {
        ...
        // 3. Create Supabase client with user session
        ...
        // 5. Verify course exists and price matches
        ...
        // Verify amount matches (with some tolerance for currency conversion)
        ...
        const { data: payment, error: paymentError } = await supabase
            ...
            .insert({
                ...
                provider_reference: transaction_id.toString(),
                status: 'success',
